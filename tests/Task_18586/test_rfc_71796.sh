...
echo `date`
echo "---Test: add xacml_profileid to GSI PEP callout---"
#########################################################
...
if [ $passed == "no" ]; then
echo "---Test: add xacml_profileid to GSI PEP callout: TEST FAILED---"
echo `date`
exit 1
else
echo "---Test: add xacml_profileid to GSI PEP callout: TEST PASSED---"
echo `date`
exit 0
fi
