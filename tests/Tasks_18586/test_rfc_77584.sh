...
echo `date`
echo "---Test: PAP maven project as child of argus-parent---"
#########################################################
...
if [ $passed == "no" ]; then
echo "---Test: PAP maven project as child of argus-parent: TEST FAILED---"
echo `date`
exit 1
else
echo "---Test: PAP maven project as child of argus-parent: TEST PASSED---"
echo `date`
exit 0
fi
